...
class AcousticMetaForCausalLM(ABC):
    ...
    def encode_wavs(self, wavs):
        ...
        wav_features = self.get_model().acoustic_projector(wav_features)
        return wav_features
    ...
    def prepare_inputs_labels_for_multimodal(
        ...
        wav_features = self.encode_wavs(wavs)
        ...
        for batch_idx, cur_input_ids in enumerate(input_ids):
            ...
            if num_images == 0:
                cur_image_features = wav_features[cur_image_idx]

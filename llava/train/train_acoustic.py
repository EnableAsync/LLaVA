...
from llava.model.language_model.llava_acoustic import AcousticLlamaForCausalLM
...
def train(attn_implementation=None):
    ...
    if model_args.wav_processor is not None:
        if 'mpt' in model_args.model_name_or_path:
            ...
            model = AcousticLlamaForCausalLM.from_pretrained(
                model_args.model_name_or_path,
                cache_dir=training_args.cache_dir,
